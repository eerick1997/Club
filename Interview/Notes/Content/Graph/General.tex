...
\begin{center}
    \begin{tikzpicture}[scale=0.2]
    \tikzstyle{every node}+=[inner sep=0pt]
    \draw [black] (8.9,-7) circle (3);
    \draw (8.9,-7) node {$0$};
    \draw [black] (7.9,-20.6) circle (3);
    \draw (7.9,-20.6) node {$1$};
    \draw [black] (22.5,-13) circle (3);
    \draw (22.5,-13) node {$2$};
    \draw [black] (22.5,-39.9) circle (3);
    \draw (22.5,-39.9) node {$3$};
    \draw [black] (38.9,-39.9) circle (3);
    \draw (38.9,-39.9) node {$4$};
    \draw [black] (43.6,-11.7) circle (3);
    \draw (43.6,-11.7) node {$5$};
    \draw [black] (54.4,-3.9) circle (3);
    \draw (54.4,-3.9) node {$6$};
    \draw [black] (64.9,-12.5) circle (3);
    \draw (64.9,-12.5) node {$7$};
    \draw [black] (54.4,-21.6) circle (3);
    \draw (54.4,-21.6) node {$8$};
    \draw [black] (8.68,-9.99) -- (8.12,-17.61);
    \draw [black] (11.64,-8.21) -- (19.76,-11.79);
    \draw [black] (19.84,-14.39) -- (10.56,-19.21);
    \draw [red] (22.5,-16) -- (22.5,-36.9);
    \draw [red] (25.5,-39.9) -- (35.9,-39.9);
    \draw [black] (46.03,-9.94) -- (51.97,-5.66);
    \draw [black] (56.72,-5.8) -- (62.58,-10.6);
    \draw [black] (62.63,-14.46) -- (56.67,-19.64);
    \draw [black] (52.19,-19.57) -- (45.81,-13.73);
    \draw [red] (40.61,-11.88) -- (25.49,-12.82);
    \end{tikzpicture}
\end{center}        
\end{figure}
...
\begin{center}
    ...
    \draw [black] (7.9,-20.6) circle (3);
    \draw (7.9,-20.6) node {$1$};
    \draw [red] (22.5,-13) circle (3);
    \draw (22.5,-13) node {$2$};
    \draw [red] (22.5,-39.9) circle (3);
    \draw (22.5,-39.9) node {$3$};
    \draw [black] (38.9,-39.9) circle (3);
    \draw (38.9,-39.9) node {$4$};
    \draw [red] (43.6,-11.7) circle (3);
    \draw (43.6,-11.7) node {$5$};
    \draw [black] (54.4,-3.9) circle (3);
    \draw (54.4,-3.9) node {$6$};
    \draw [black] (64.9,-12.5) circle (3);
    ...
    \draw [black] (11.64,-8.21) -- (19.76,-11.79);
    \draw [black] (19.84,-14.39) -- (10.56,-19.21);
    \draw [black] (22.5,-16) -- (22.5,-36.9);
    \draw [black] (25.5,-39.9) -- (35.9,-39.9);
    \draw [black] (46.03,-9.94) -- (51.97,-5.66);
    \draw [black] (56.72,-5.8) -- (62.58,-10.6);
    \draw [black] (62.63,-14.46) -- (56.67,-19.64);
    \draw [black] (52.19,-19.57) -- (45.81,-13.73);
    \draw [black] (40.61,-11.88) -- (25.49,-12.82);
    \end{tikzpicture}
\end{center}        
\end{figure}
...
A minimum spaning tree (MST) is a subset of the edges connected, edge-weighted graph that connects all the vertices together, without any cycles and with the minimum possible total edge weight.
...
\begin{center}
    \begin{tikzpicture}[scale=0.2]
    \tikzstyle{every node}+=[inner sep=0pt]
    \draw [black] (9.9,-7.6) circle (3);
    \draw (9.9,-7.6) node {$A$};
    \draw [black] (33.7,-7.6) circle (3);
    \draw (33.7,-7.6) node {$B$};
    \draw [black] (50,-15.9) circle (3);
    \draw (50,-15.9) node {$C$};
    \draw [black] (25,-21.5) circle (3);
    \draw (25,-21.5) node {$D$};
    \draw [black] (3.6,-21.5) circle (3);
    \draw (3.6,-21.5) node {$E$};
    \draw [black] (5.7,-41.3) circle (3);
    \draw (5.7,-41.3) node {$F$};
    \draw [black] (25,-41.3) circle (3);
    \draw (25,-41.3) node {$G$};
    \draw [black] (39.8,-30.6) circle (3);
    \draw (39.8,-30.6) node {$H$};
    \draw [black] (55.4,-39.1) circle (3);
    \draw (55.4,-39.1) node {$I$};
    \draw [black] (67.9,-25.4) circle (3);
    \draw (67.9,-25.4) node {$J$};
    \draw [black] (8.66,-10.33) -- (4.84,-18.77);
    \draw (6.03,-13.54) node [left] {$1$};
    \draw [black] (6.6,-21.5) -- (22,-21.5);
    \draw (14.3,-22) node [below] {$2$};
    \draw [black] (12.11,-9.63) -- (22.79,-19.47);
    \draw (16.43,-15.04) node [below] {$9$};
    \draw [black] (26.59,-18.96) -- (32.11,-10.14);
    \draw (29.98,-15.84) node [right] {$2$};
    \draw [black] (12.9,-7.6) -- (30.7,-7.6);
    \draw (21.8,-8.1) node [below] {$5$};
    \draw [black] (36.37,-8.96) -- (47.33,-14.54);
    \draw (40.86,-12.25) node [below] {$4$};
    \draw [black] (27.56,-23.07) -- (37.24,-29.03);
    \draw (31.4,-26.55) node [below] {$2$};
    \draw [black] (48.29,-18.36) -- (41.51,-28.14);
    \draw (44.3,-21.89) node [left] {$4$};
    \draw [black] (25,-24.5) -- (25,-38.3);
    \draw (24.5,-31.4) node [left] {$1$};
    \draw [black] (27.43,-39.54) -- (37.37,-32.36);
    \draw (33.4,-36.45) node [below] {$1$};
    \draw [black] (3.92,-24.48) -- (5.38,-38.32);
    \draw (4,-31.5) node [left] {$1$};
    \draw [black] (8.7,-41.3) -- (22,-41.3);
    \draw (15.35,-41.8) node [below] {$7$};
    \draw [black] (7.79,-39.15) -- (22.91,-23.65);
    \draw (15.88,-32.87) node [right] {$5$};
    \draw [black] (42.43,-32.04) -- (52.77,-37.66);
    \draw (46.6,-35.35) node [below] {$6$};
    \draw [black] (27.99,-41.08) -- (52.41,-39.32);
    \draw (40.3,-40.76) node [below] {$4$};
    \draw [black] (50.68,-18.82) -- (54.72,-36.18);
    \draw (51.95,-27.91) node [left] {$1$};
    \draw [black] (57.42,-36.88) -- (65.88,-27.62);
    \draw (62.19,-33.71) node [right] {$0$};
    \draw [black] (52.65,-17.31) -- (65.25,-23.99);
    \draw (57.96,-21.15) node [below] {$8$};
    \end{tikzpicture}
\end{center}       
\end{figure}

Using the example above we find the next minimum spaning tree
...
\textbf{Algorithms:} Kruskal's, Prim's and Boruvka's algorithm 

\subsubsection{Network flow: max flow}

Question: with an infinite input source how much ''flow'' can we push throught the network?

\begin{figure}[H]
\begin{center}
    \begin{tikzpicture}[scale=0.2]
    \tikzstyle{every node}+=[inner sep=0pt]
    \draw [black] (3.2,-28) circle (3);
    \draw [black] (3.2,-28) circle (2.4);
    \draw [black] (75.4,-28) circle (3);
    \draw [black] (75.4,-28) circle (2.4);
    \draw [black] (18.5,-14.7) circle (3);
    \draw [black] (18.5,-28) circle (3);
    \draw [black] (18.5,-41.7) circle (3);
    \draw [black] (36.8,-14.7) circle (3);
    \draw [black] (36.8,-28) circle (3);
    \draw [black] (36.8,-42.4) circle (3);
    \draw [black] (54.5,-14.7) circle (3);
    \draw [black] (54.5,-28) circle (3);
    \draw [black] (54.5,-42.4) circle (3);
    \draw [black] (5.46,-26.03) -- (16.24,-16.67);
    \fill [black] (16.24,-16.67) -- (15.3,-16.82) -- (15.96,-17.57);
    \draw (11.86,-21.84) node [below] {$1$};
    \draw [black] (6.2,-28) -- (15.5,-28);
    \fill [black] (15.5,-28) -- (14.7,-27.5) -- (14.7,-28.5);
    \draw (10.85,-28.5) node [below] {$2$};
    \draw [black] (5.43,-30) -- (16.27,-39.7);
    \fill [black] (16.27,-39.7) -- (16,-38.79) -- (15.34,-39.54);
    \draw (9.84,-35.34) node [below] {$1$};
    \draw [black] (21.5,-14.7) -- (33.8,-14.7);
    \fill [black] (33.8,-14.7) -- (33,-14.2) -- (33,-15.2);
    \draw (27.65,-15.2) node [below] {$2$};
    \draw [black] (21.5,-28) -- (33.8,-28);
    \fill [black] (33.8,-28) -- (33,-27.5) -- (33,-28.5);
    \draw (27.65,-28.5) node [below] {$\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }\mbox{ }5$};
    \draw [black] (20.93,-16.46) -- (34.37,-26.24);
    \fill [black] (34.37,-26.24) -- (34.02,-25.36) -- (33.43,-26.17);
    \draw (26.65,-21.85) node [below] {$4$};
    \draw [black] (20.86,-29.86) -- (34.44,-40.54);
    \fill [black] (34.44,-40.54) -- (34.12,-39.66) -- (33.5,-40.44);
    \draw (26.64,-35.7) node [below] {$6$};
    \draw [black] (20.18,-39.22) -- (35.12,-17.18);
    \fill [black] (35.12,-17.18) -- (34.25,-17.57) -- (35.08,-18.13);
    \draw (28.26,-29.54) node [right] {$4$};
    \draw [black] (39.8,-14.7) -- (51.5,-14.7);
    \fill [black] (51.5,-14.7) -- (50.7,-14.2) -- (50.7,-15.2);
    \draw (45.65,-15.2) node [below] {$7$};
    \draw [black] (39.8,-42.4) -- (51.5,-42.4);
    \fill [black] (51.5,-42.4) -- (50.7,-41.9) -- (50.7,-42.9);
    \draw (45.65,-42.9) node [below] {$3$};
    \draw [black] (21.3,-40.63) -- (51.7,-29.07);
    \fill [black] (51.7,-29.07) -- (50.77,-28.88) -- (51.13,-29.82);
    \draw (37.44,-35.37) node [below] {$8$};
    \draw [black] (36.8,-31) -- (36.8,-39.4);
    \fill [black] (36.8,-39.4) -- (37.3,-38.6) -- (36.3,-38.6);
    \draw (36.3,-35.2) node [left] {$8$};
    \draw [black] (39.2,-26.2) -- (52.1,-16.5);
    \fill [black] (52.1,-16.5) -- (51.16,-16.58) -- (51.76,-17.38);
    \draw (47.4,-21.85) node [below] {$\mbox{ }\mbox{ }\mbox{ }3$};
    \draw [black] (39.13,-29.89) -- (52.17,-40.51);
    \fill [black] (52.17,-40.51) -- (51.87,-39.61) -- (51.24,-40.39);
    \draw (44.64,-35.69) node [below] {$3$};
    \draw [black] (51.505,-28.038) arc (-94.56009:-159.28322:16.25);
    \fill [black] (51.5,-28.04) -- (50.75,-27.48) -- (50.67,-28.47);
    \draw (42.03,-25.33) node [below] {$1$};
    \draw [black] (57.03,-16.31) -- (72.87,-26.39);
    \fill [black] (72.87,-26.39) -- (72.46,-25.54) -- (71.93,-26.38);
    \draw (63.95,-21.85) node [below] {$1$};
    \draw [black] (57.5,-28) -- (72.4,-28);
    \fill [black] (72.4,-28) -- (71.6,-27.5) -- (71.6,-28.5);
    \draw (64.95,-28.5) node [below] {$3$};
    \draw [black] (56.97,-40.7) -- (72.93,-29.7);
    \fill [black] (72.93,-29.7) -- (71.99,-29.74) -- (72.55,-30.57);
    \draw (65.95,-35.7) node [below] {$4$};
    \draw [black] (3.2,-17.3) -- (3.2,-25);
    \draw (3.2,-16.8) node [above] {$Source$};
    \fill [black] (3.2,-25) -- (3.7,-24.2) -- (2.7,-24.2);
    \draw [black] (74.4,-16.7) -- (75.14,-25.01);
    \draw (74.05,-16.02) node [above] {$Sink$};
    \fill [black] (75.14,-25.01) -- (75.56,-24.17) -- (74.57,-24.26);
    \end{tikzpicture}
\end{center}        
\end{figure}

Suppose the edges are roads with cars, pipes with water or hallways with packed with people. Flow represnets the volume of water allowed to flow through the pipes, the number of cars the roads can sustain in traffic and the maximum amount of people that can navigate through the hallways.\\

\textbf{Algorithms:} Ford-Fulkerson, Edmonds-Karp and Dinic's algorithm

\subsection{Depth First Search (DFS)}
\input{Content/Graph/DFS.tex}

\subsection{Breadth First Search (BFS)}
\input{Content/Graph/BFS.tex}
